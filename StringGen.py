...
API_TEXT = """Hi {}
Welcome ᴛᴏ ᴅᴀɪsʏ sᴛʀɪɴɢ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ ❤.
...
async def genStr(bot: Bot, msg: Message):
    ...
    await client.send_message("me", f"#PYROGRAM #DaisyX_STRING_SESSION\n\n```{session_string}```")

    text = "`String Session is Successfully Generated ʙʏ ᴅᴀɪsʏx sᴛʀɪɴɢ ɢᴇɴᴇʀᴀᴛᴏʀ ❤ (@DaisyXStringGenBot).\nClick on Button Below.`"
...
async def restart(bot: Bot, msg: Message):
    if msg.from_user.id == 1513257955:
        await msg.reply('✅')
...
(C) Author: [Team DaisyX](https://t.me/TeamDaisyX) and \
[Support Group](https://t.me/DaisySupport_Official)
Give a Star ⭐️ to [REPO](https://github.com/SkemTools/DaisyXStringGenerator) if you like this Bot.
"""
